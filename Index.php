                    ...
                    <tbody>
                        <?php
                            ...
                            while ($data = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<form action=\"./update_mahasiswa.php\" method=\"post\" class=\"d-inline-block mb-2\">";
                                echo "<input type=\"hidden\" name=\"id\" value=\"$data[id]\">";
                                echo "<input type=\"submit\" name=\"submit\" value=\"Update\" style=\"width:80px\" class=\"btn btn-info text-white\">";
                                echo "</form>";
                                echo "<form action=\"./delete_mahasiswa.php\" method=\"post\" class=\"d-inline-block\">";
                                echo "<input type=\"hidden\" name=\"id\" value=\"$data[id]\">";
                                echo "<input type=\"submit\" name=\"submit\" value=\"Delete\" style=\"width:80px\" class=\"btn btn-danger\">";
                                echo "</form>";
                                echo "</th>";
                                echo "</tr>";
                                $i++;
