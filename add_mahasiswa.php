...
if (isset($_POST["submit"])) { // submit button clicked
    ...
    if ($error_message === "") {
        ...
        $tempat_lahir = mysqli_real_escape_string($connection, $tempat_lahir);
        $jenis_kelamin = mysqli_real_escape_string($connection, $jenis_kelamin);
        $fakultas = mysqli_real_escape_string($connection, $fakultas);
        $jurusan = mysqli_real_escape_string($connection, $jurusan);
        $tanggal_lahir = mysqli_real_escape_string($connection, $tanggal_lahir);
        $ipk = (float)$ipk;
        ...
        <section>
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ipk" id="ipk" class="form-control" value="<?php echo (isset($ipk)) ? $ipk : ""; ?>" placeholder="Contoh: 3.85">
